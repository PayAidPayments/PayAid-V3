      ...
      onRehydrateStorage: () => {
        return (state, error) => {
          ...
          if (state) {
            ...
            // If we have a token and user/tenant data, mark as authenticated
            ...
            // If state is null/undefined, set defaults
            // Don't call setState here as it can cause circular dependency
            return {
              isLoading: false,
              isAuthenticated: false,
            }
