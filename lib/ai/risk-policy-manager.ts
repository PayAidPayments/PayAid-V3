...
export async function getCompanyRiskPolicy(
  ...
  return {
    ...
    amountThreshold: policy.amountThreshold ?? undefined,
    ...
    maxAutoExecuteAmount: policy.maxAutoExecuteAmount ?? undefined,
...
export async function setCompanyRiskPolicy(
  ...
  if (existing) {
    ...
    return {
      ...
      customBaseRisk: updated.customBaseRisk ?? undefined,
      amountThreshold: updated.amountThreshold ?? undefined,
      autoApproveThreshold: updated.autoApproveThreshold ?? undefined,
      requireApprovalThreshold: updated.requireApprovalThreshold ?? undefined,
      maxAutoExecuteAmount: updated.maxAutoExecuteAmount ?? undefined,
    ...
    return {
      ...
      customBaseRisk: created.customBaseRisk ?? undefined,
      amountThreshold: created.amountThreshold ?? undefined,
      autoApproveThreshold: created.autoApproveThreshold ?? undefined,
      requireApprovalThreshold: created.requireApprovalThreshold ?? undefined,
      maxAutoExecuteAmount: created.maxAutoExecuteAmount ?? undefined,
