...
export const VOICE_OPTIONS: VoiceOption[] = [
  { id: 'arjun-formal', label: 'Abhilash (Male, Formal)' },
  { id: 'arjun-calm', label: 'Rahul (Male, Calm)' },
  { id: 'arjun-warm', label: 'Aditya (Male, Warm)' },
  { id: 'divya-formal', label: 'Vidya (Female, Formal)' },
  { id: 'divya-calm', label: 'Anushka (Female, Calm)' },
  { id: 'divya-warm', label: 'Manisha (Female, Warm)' },
