...
const stubPath = path.join(root, 'docs', 'evidence', 'voice-agent', 'bolna-stage1-sidecar-env.stub')
...
writeFileSync(
  ...
  serializeEnv(
    existingMap,
    'Generated/merged by npm run voice-agent:apply-bolna-sidecar-stub (fills missing keys only)',
  ),
  'utf8',
)
