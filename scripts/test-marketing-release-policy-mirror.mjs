...
const fullScript =
  'cross-env MARKETING_RELEASE_PRODUCTION_VERIFICATION_WARNING_ONLY=1 MARKETING_RELEASE_PRODUCTION_VERIFICATION_TIMEOUT_MS=300000 MARKETING_RELEASE_PRODUCTION_VERIFICATION_TIMEOUT_MS_EVIDENCE_HELPERS_SUITE=600000 MARKETING_RELEASE_PRODUCTION_VERIFICATION_TIMEOUT_MS_EVIDENCE_BUNDLE=600000 MARKETING_RELEASE_GATE_EVIDENCE_BUNDLE_STEP_TIMEOUT_MS=180000 MARKETING_RELEASE_EVIDENCE_HELPERS_SUITE_STEP_TIMEOUT_MS=180000 MARKETING_RELEASE_INCLUDE_EVIDENCE_HELPERS=1 MARKETING_RELEASE_INCLUDE_EVIDENCE_LATENCY_GATE=1 MARKETING_RELEASE_EVIDENCE_HELPERS_WARNING_ONLY=1 MARKETING_RELEASE_EVIDENCE_LATENCY_GATE_WARNING_ONLY=1 node scripts/noop.mjs'
const driftScript =
