...
const timeoutMs = Number(process.env.LEAD_INTELLIGENCE_M1_CLOSURE_TIMEOUT_MS || 240000)
const perSuiteTimeoutMs = Number(
  process.env.LEAD_INTELLIGENCE_M1_CLOSURE_TIMEOUT_PER_SUITE_MS || 180000
)

const tests = [
  '__tests__/m0/m0-lead-intelligence-api-routes.test.ts',
  '__tests__/m0/m0-lead-intelligence-no404-contract.test.ts',
]
...
const artifactPath = path.join(artifactDir, `${stamp}-lead-intelligence-m1-closure-check.md`)
...
const content = `# Lead Intelligence M1 Closure Check
