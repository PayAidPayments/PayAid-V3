...
export default function AIInsightsDashboardPage() {
  ...
  const moduleConfig = getModuleConfig('ai-insights') || getModuleConfig('crm')!

  const heroMetrics = [
    { label: 'Insights', value: '0', icon: <Lightbulb className="w-5 h-5" />, color: 'purple' as const },
  ]
        ...
        <GlassCard>
          ...
          <CardContent>
            <div className="text-center py-12 text-gray-500">
              ...
              <p>AI insights will appear here as you use PayAid modules.</p>
            </div>
          </CardContent>
        </GlassCard>
      </div>
