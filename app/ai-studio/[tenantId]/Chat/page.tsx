      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <div className="group relative">
            ...
            <div className="absolute left-0 bottom-full mb-2 w-64 p-3 bg-white border-2 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 border-blue-500">
              <p className="text-xs font-semibold mb-1 text-blue-600">AI Chat</p>
              <p className="text-xs text-gray-600">General-purpose conversational AI assistant. Perfect for casual questions, general information, and non-business related conversations.</p>
              <p className="text-xs text-gray-500 mt-2">Use for: General questions, casual chat, non-business topics</p>
              <p className="text-xs text-blue-600 mt-2 font-medium">💡 Tip: For business-specific questions, use AI Co-Founder instead</p>
            </div>
          </div>
        </div>
        <p className="mt-2 text-gray-600">General-purpose AI assistant for casual conversations and general questions</p>
      </div>
