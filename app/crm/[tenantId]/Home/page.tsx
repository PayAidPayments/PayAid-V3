...
const AutoGeneratedSummary = dynamic(
  () => import('@/components/ai/AutoGeneratedSummary').then(mod => ({ default: mod.AutoGeneratedSummary })),
  { ssr: false, loading: () => null }
)
const IntelligentAlerts = dynamic(
  () => import('@/components/ai/IntelligentAlerts').then(mod => ({ default: mod.IntelligentAlerts })),
  { ssr: false, loading: () => null }
)
