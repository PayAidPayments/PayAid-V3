...
// Lazy load AI components - only load when needed
const FloatingAIAssistant = dynamic(() => import('@/components/ai/FloatingAIAssistant').then(mod => ({ default: mod.FloatingAIAssistant })), { ssr: false })
const SmartInsights = dynamic(() => import('@/components/ai/SmartInsights').then(mod => ({ default: mod.SmartInsights })), { ssr: false })
const PredictiveAnalytics = dynamic(() => import('@/components/ai/PredictiveAnalytics').then(mod => ({ default: mod.PredictiveAnalytics })), { ssr: false })
const AutoGeneratedSummary = dynamic(() => import('@/components/ai/AutoGeneratedSummary').then(mod => ({ default: mod.AutoGeneratedSummary })), { ssr: false })
const IntelligentAlerts = dynamic(() => import('@/components/ai/IntelligentAlerts').then(mod => ({ default: mod.IntelligentAlerts })), { ssr: false })
const HealthMonitoring = dynamic(() => import('@/components/ai/HealthMonitoring').then(mod => ({ default: mod.HealthMonitoring })), { ssr: false }).then(mod => ({ default: mod.HealthMonitoring })), { ssr: false })
import { 
  LineChart, 
  Line, 
  BarChart, 
