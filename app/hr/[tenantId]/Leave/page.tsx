        ...
        <div className="px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-4 text-sm">
              ...
              <Link href={`/hr/${tenantId}/Leave`} className="text-pink-600 font-medium border-b-2 border-pink-600 pb-2">Leave</Link>
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-gray-600">Manage employee leave requests and balances</p>
          </div>
          ...
          <Link href="/dashboard/hr/leave/requests">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardHeader>
                ...
                <CardDescription>View and approve leave requests</CardDescription>
              </CardHeader>
            </Card>
          </Link>

          <Link href="/dashboard/hr/leave/balances">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardHeader>
                <CardTitle>Leave Balances</CardTitle>
                <CardDescription>View employee leave balances</CardDescription>
              </CardHeader>
            </Card>
          </Link>
        </div>
