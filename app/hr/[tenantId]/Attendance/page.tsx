        ...
        <div className="px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-4 text-sm">
              ...
              <Link href={`/hr/${tenantId}/Attendance`} className="text-pink-600 font-medium border-b-2 border-pink-600 pb-2">Attendance</Link>
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-gray-600">Track employee attendance and check-ins</p>
          </div>
          <Link href="/dashboard/hr/attendance/check-in">
            <Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link href="/dashboard/hr/attendance/calendar">
          ...
          <Link href="/dashboard/hr/attendance/check-in">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardHeader>
                ...
                <CardDescription>Employee check-in and check-out</CardDescription>
              </CardHeader>
            </Card>
          </Link>
        </div>
