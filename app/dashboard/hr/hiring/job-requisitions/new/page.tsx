...
export default function NewJobRequisitionPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (data) => {
      router.push(`/dashboard/hr/hiring/job-requisitions/${data.id}`)
    },
    onError: (err: Error) => {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600">Create a new job opening</p>
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Job Requisition Details</CardTitle>
          <CardDescription>Enter the job opening details below</CardDescription>
        </CardHeader>
        <CardContent>
