...
/**
 * Sales Module Login Page
 * Module-specific login with Sales branding
 * After login, redirects to Sales dashboard: /sales/[tenantId]/Home/
 */
export default function SalesLoginPage() {
  ...
  if (isAuthenticated && tenant?.id) {
    return <PageLoading message="Redirecting to Sales..." fullScreen={true} />
  }
