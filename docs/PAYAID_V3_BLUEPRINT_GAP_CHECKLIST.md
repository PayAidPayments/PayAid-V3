...
- Latest consolidated status: `docs/evidence/closure/2026-04-25T16-40-39-125Z-canonical-closeout-status-snapshot.md`
- Current state: `FAIL` (expected until time-gated monitoring windows complete)
- Next due checkpoint: `tplus16` at `2026-04-26T00:00:00.000Z` (remaining `440` minutes at last refresh)
- Next command when due: `npm run run:canonical-monitor:tplus16`
