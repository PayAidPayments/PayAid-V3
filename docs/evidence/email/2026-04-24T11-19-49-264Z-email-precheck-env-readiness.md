...
- Ready for precheck command: yes

## Variable checks

- DATABASE_URL present: yes
- DATABASE_URL endpoint preview: aws-1-ap-northeast-1.pooler.supabase.com:5432
- REDIS_URL present: yes
- REDIS_URL endpoint preview: beloved-gull-95753.upstash.io:6379
- REDIS_URL source: derived_from_upstash_rest
