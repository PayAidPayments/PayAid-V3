...
export default function NewTaxDeclarationPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (data) => {
      router.push(`/dashboard/hr/tax-declarations/${data.id}`)
    },
    onError: (err: Error) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">New Tax Declaration</h1>
          <p className="mt-2 text-gray-600">Create a new tax declaration</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Enter the tax declaration information</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <label htmlFor="declaredAmountInr" className="text-sm font-medium text-gray-700">
