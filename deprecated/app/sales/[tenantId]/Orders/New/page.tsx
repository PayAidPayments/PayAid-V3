    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">Create a new order for a customer</p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <Card className="dark:bg-gray-800 dark:border-gray-700">
              <CardHeader>
                ...
                <CardDescription className="dark:text-gray-400">Select or enter customer details</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <label htmlFor="customerId" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    Select Customer
                  </label>
                  <select
                    id="customerId"
            ...
            <Card className="dark:bg-gray-800 dark:border-gray-700">
              <CardHeader>
                <CardTitle className="dark:text-gray-100">Shipping Address</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <label htmlFor="shippingAddress" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    Address *
                  </label>
                  <Input
                    id="shippingAddress"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    <label htmlFor="shippingCity" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                      City *
                    </label>
                    <Input
                      id="shippingCity"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="shippingPostal" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                      Postal Code *
                    </label>
                    <Input
                      id="shippingPostal"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="shippingCountry" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                      Country
                    </label>
                    <Input
                      id="shippingCountry"
            ...
            <Card className="dark:bg-gray-800 dark:border-gray-700">
              <CardHeader>
                ...
                <CardDescription className="dark:text-gray-400">Add products to this order</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  <select
                    ...
                    className="flex-1 h-10 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 px-3 py-2 text-sm"
                    disabled={isSubmitting}
                  >
                  ...
                  <div className="border dark:border-gray-700 rounded-md">
                    <table className="w-full">
                      <thead className="bg-gray-50 dark:bg-gray-700">
                        <tr>
                          <th className="px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-300">Product</th>
                          ...
                          <tr key={index}>
                            ...
                            <td className="px-4 py-2">
                              <Input
                                ...
                                className="w-32 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600"
                                disabled={isSubmitting}
                              />
                            </td>
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900 dark:text-gray-100">₹{tax.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600 dark:text-gray-400">Shipping</span>
                    <span className="font-medium text-gray-900 dark:text-gray-100">₹{shipping.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
                  </div>
            ...
            <Card className="dark:bg-gray-800 dark:border-gray-700">
              <CardHeader>
                <CardTitle className="dark:text-gray-100">Payment Method</CardTitle>
              </CardHeader>
              <CardContent>
                <select
                  name="paymentMethod"
            ...
            <div className="flex gap-4">
              <Link href={`/sales/${tenantId}/Orders`} className="flex-1">
                <Button type="button" variant="outline" className="w-full dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700" disabled={isSubmitting}>
                  Cancel
                </Button>
              </Link>
              <Button type="submit" className="flex-1 dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-600" disabled={isSubmitting || items.length === 0}>
