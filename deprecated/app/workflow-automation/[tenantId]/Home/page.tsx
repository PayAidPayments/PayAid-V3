...
export default function WorkflowAutomationDashboardPage() {
  ...
  const moduleConfig = getModuleConfig('workflow-automation') || getModuleConfig('crm')!

  const heroMetrics = [
    { label: 'Active Workflows', value: '0', icon: <GitBranch className="w-5 h-5" />, color: 'purple' as const },
    { label: 'Templates', value: '0', icon: <Settings className="w-5 h-5" />, color: 'info' as const },
  ]
