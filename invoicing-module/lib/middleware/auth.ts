...
/**
 * Require authentication for Invoicing module routes
...
/**
 * Optional authentication for Invoicing module routes
...
/**
 * Check if user has Invoicing module access
 */
export function requireInvoicingAccess(request: NextRequest): {
  ...
  // Check if Invoicing module is licensed
