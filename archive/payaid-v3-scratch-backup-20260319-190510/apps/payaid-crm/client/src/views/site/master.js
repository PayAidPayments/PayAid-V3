...
class MasterSiteView extends View {
    ...
    afterRender() {
        ...
        if (footerView) {
            ...
            if ((html.match(/payaid/gi) || []).length < 1) {
                const text = 'PHAgY2xhc3M9ImNyZWRpdCBzbWFsbCI+JmNvcHk7IDIwMjYgPGEgaHJlZj0iaHR0cHM6Ly9wYXlhaWQuY29tIiB0aXRsZT0iUGF5QWlkIENSTSI+UGF5QWlkIENSTTwvYT48L3A+';
