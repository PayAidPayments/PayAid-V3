...
/**
 * POST /api/ai/ai-studio/image/generate
 * AI Studio: cache, rate limits, blocklist, brand guidelines → /api/ai/generate-image.
 * (Formerly POST /api/ai/image/generate — use /api/ai/image/generate for Marketing Comfy/worker primitive.)
 */
