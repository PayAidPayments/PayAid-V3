 ...
 * Module-specific login with Finance branding
 * After login, redirects to Finance dashboard: /finance/[tenantId]/Home/
 */
export default function FinanceLoginPage() {
  ...
  if (isAuthenticated && tenant?.id) {
    return <PageLoading message="Redirecting to Finance..." fullScreen={true} />
  }
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4" autoComplete="on">
            ...
            <Button 
              ...
              disabled={isLoading}
            >
              {isLoading ? 'Signing in...' : 'Sign in to Finance'}
            </Button>
