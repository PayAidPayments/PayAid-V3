...
export default function NewDebitNotePage() {
  ...
  // Determine GST type
  const isInterState = formData.customerState && formData.customerState !== 'Maharashtra'
  ...
  const createDebitNote = useMutation({
    mutationFn: async () => {
      const response = await fetch('/api/finance/debit-notes', {
        method: 'POST',
        headers: {
    ...
    onSuccess: (data) => {
      router.push(`/finance/${tenantId}/Debit-Notes/${data.debitNote.id}`)
    },
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert((error as Error).message || 'Failed to create debit note')
    } finally {
    ...
    <div className="w-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 relative" style={{ zIndex: 1 }}>
      <div className="p-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Create Debit Note</h1>
            <p className="text-sm text-muted-foreground mt-1">Create a debit note for additional charges or price adjustments</p>
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <label className="text-sm font-medium mb-2 block">Debit Note Date *</label>
                    <Input
                      type="date"
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Add items for this debit note</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
