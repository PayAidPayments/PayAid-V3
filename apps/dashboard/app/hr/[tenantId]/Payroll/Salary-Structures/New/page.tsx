...
export default function NewSalaryStructurePage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (data) => {
      router.push(`/hr/${tenantId}/Payroll/Salary-Structures`)
    },
    onError: (err: Error) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">New Salary Structure</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Create a new salary component structure</p>
        </div>
      ...
      <Card className="dark:bg-gray-800 dark:border-gray-700">
        <CardHeader>
          <CardTitle className="dark:text-gray-100">Structure Information</CardTitle>
          <CardDescription className="dark:text-gray-400">Enter the salary structure details</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold dark:text-gray-100">Salary Components</h3>
                <Button type="button" onClick={addComponent} variant="outline" className="dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700">
                  Add Component
                </Button>
              </div>
            ...
            <div className="flex justify-end gap-4 pt-4">
              ...
              <Button
                ...
                title={createMutation.isPending ? 'Please wait' : 'Create salary structure'}
              >
