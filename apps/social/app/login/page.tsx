  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
        <h1 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Log in to PayAid Social</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
          Use your PayAid account. Standalone Social sign-in coming soon.
        </p>
        <Link
          href="/studio"
