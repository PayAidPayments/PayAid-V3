  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <main className="max-w-7xl mx-auto w-full px-4 py-6">
        <h1 className="text-xl font-semibold text-slate-900 dark:text-white mb-6">Analytics</h1>
        <p className="text-slate-600 dark:text-slate-400">Campaign and post performance. Connect to MarketingPost and Campaign stats.</p>
      </main>
    </div>
  )
}
